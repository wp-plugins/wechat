...
Plugin URI: http://blogqun.com/wechat.html
...
<div class="wrap">
  ...
  <p><?php _e('Documentation:', 'wechat');?> <a href="http://blogqun.com/doc/wechat.html" target="_blank">http://blogqun.com/doc/wechat.html</a></p>
  <p><?php _e('Current Features:', 'wechat');?></p>
  <?php _e('<p>1. Use WeChat/Yinxin/Sina weibo messages to search Wordoress Posts</p><p>2. custom keywords to reply (include text, image + text, custom image + text, music and etc...)</p><p>3. message records (transcripts betweens clients and public account)</p><p>4. Data Analizy ( included message record，keywords，user activities)</p><p>5. WeChat custom menu ( WeChat Service account should apply)</p><p>6. User could use WeChat to publish Weibo ( need <a href="http://blogqun.com/wp-connect.html" target="_blank">WP Connect</a> plugin )</p><p>7. support automaticly update from Wordpress backend.</p>', 'wechat');?></p>
  <h3><?php _e('only：￥149 RMB or $28 USD Buy Now: <a href="http://blogqun.com/wechat.html" target="_blank">http://blogqun.com/wechat.html</a>', 'wechat');?></h3>
  <p><?php _e('<a href="http://blogqun.com/wp-connect.html" target="_blank">WP Connect Pro</a> Version User could gain 8 Discount，enter your registered domain to get discount details.', 'wechat');?></p>
